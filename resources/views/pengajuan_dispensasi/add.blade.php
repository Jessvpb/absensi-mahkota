...
@section('page-description', 'Buat pengajuan dispensasi baru')
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="glass-card rounded-2xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-white mb-2">Form Pengajuan Dispensasi</h2>
                    <p class="text-gray-400">Lengkapi form di bawah untuk mengajukan dispensasi</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-2xl p-6">
            <h3 class="text-xl font-semibold text-white mb-6 flex items-center">
                ...
                Detail Pengajuan Dispensasi
            </h3>

            <form method="POST" action="{{ route('pengajuandispensasi.add') }}" class="space-y-6">
                @csrf
        ...
        <div class="glass-card rounded-2xl p-6 border border-blue-500/30 bg-blue-500/10">
            <div class="flex items-start">
                ...
                <div>
                    <h4 class="text-blue-400 font-semibold mb-2">Informasi Pengajuan Dispensasi</h4>
                ...
                rows.forEach((row, index) => {
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-700/30 rounded-lg">
                        <div>
                            ...
                            <p class="text-gray-400 text-sm italic">${keterangan || 'Tidak ada keterangan'}</p>
                        </div>
            ...
            container.addEventListener('click', function(e) {
                if (e.target.classList.contains('btn-remove') || e.target.closest('.btn-remove')) {
                    ...
                    if (container.querySelectorAll('.detail-row').length > 1) {
                        ...
                        alert('Minimal harus ada satu hari dispensasi');
                    }
                }
            });
