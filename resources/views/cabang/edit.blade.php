    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="glass-card rounded-2xl p-6">
            ...
            <div class="bg-gray-800/30 rounded-lg p-4">
                ...
                <div class="border-t border-gray-700/50 pt-4 mb-4"></div>
            ...
            <form action="{{ route('cabang.edit', $cabang->id) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_masuk"
                            value="{{ old('jam_masuk', \Carbon\Carbon::parse($cabang->jam_masuk)->format('H:i')) }}"
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_pulang"
                            value="{{ old('jam_pulang', \Carbon\Carbon::parse($cabang->jam_pulang)->format('H:i')) }}"
                            class="w-full px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-xl text-white focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all"
                            required>
                        @error('jam_pulang')
                            <p class="text-red-400 text-sm mt-1">
                ...
                <div>
                    ...
                    <select name="is_active"
                        class="w-full px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-xl text-white focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all"
                        required>
                        <option value="1" {{ old('is_active', $cabang->is_active) == 1 ? 'selected' : '' }}>Aktif
                        </option>
                        <option value="0" {{ old('is_active', $cabang->is_active) == 0 ? 'selected' : '' }}>Tidak
                            Aktif</option>
                    </select>
                    @error('is_active')
                        <p class="text-red-400 text-sm mt-1">
